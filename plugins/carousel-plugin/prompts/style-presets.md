...
## Minimalist
Light background, thin fonts, maximum whitespace, muted earth tones.
```json
{
  "name": "",
  "visual": {
...
## Bold
Dark background, heavy sans-serif, high contrast, vibrant accent.
```json
{
  "name": "",
  "visual": {
...
## Editorial
Dark background, serif headlines for sophistication, magazine aesthetic.
```json
{
  "name": "",
  "visual": {
...
## Corporate
Light background, clean sans-serif, structured and professional, blue accent.
```json
{
  "name": "",
  "visual": {
...
## Neon/Tech
Dark background, monospace accents, bright neon accent, cyberpunk feel.
```json
{
  "name": "",
  "visual": {
